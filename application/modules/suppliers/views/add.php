<div class="mws-panel grid_8">
					...
					<?php if($message) { echo "<div class=\"alert alert-error\"><button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>" . $message . "</div>"; } ?>
                    	<form class="mws-form" action="<?php echo base_url(); ?>suppliers/add" method="POST">
                    		<div class="mws-form-inline">
								...
								<div class="mws-form-row">
                    				...
                    				<div class="mws-form-item">
                    					<input type="email" name="email" class="small" required="required" >
                    				</div>
                    			</div>
								...
								<div class="mws-form-row">
                    				...
                    				<div class="mws-form-item">
                    					<input type="text" name="address" class="small" required="required" >
                    				</div>
                    			</div>
								...
								<div class="mws-form-row">
                    				...
                    				<div class="mws-form-item">
                    					<input type="text" name="city" class="small" required="required" >
                    				</div>
                    			</div>
								...
								<div class="mws-form-row">
                    				...
                    				<div class="mws-form-item">
                    					<input type="text" name="postal_code" class="small" required="required" >
                    				</div>
                    			</div>
								...
								<div class="mws-form-row">
                    				...
                    				<div class="mws-form-item">
                    					<input type="text" name="country" class="small" required="required" >
                    				</div>
                    			</div>
								...
								<div class="mws-form-row">
                    				...
                    				<div class="mws-form-item">
                    					<input type="text" name="company" class="small" required="required" >
                    				</div>
                    			</div>
