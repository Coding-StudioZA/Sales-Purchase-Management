    ...
    $(document).ready(function(){
		...
		$("body").on("change" , "#product_id" , function() {
			...
			if(total_qty > 0) { 
				...
				$.ajax({
					type: 'POST',
					url: '<?php echo site_url("sales/add_product_ajax"); ?>',
					data:form_data,
		...
		$("body").on("keyup" , "#tax , #discount" , function() {
			get_total_price();
		});
		//$("#check_n").hide();
...
<div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-body no-padding">
                    	...
                    	<form class="mws-form" action="<?php echo base_url(); ?>sales/edit/<?php echo $sale->id; ?>" method="POST">
                    		<div class="mws-form-row">
								<div class="mws-form-cols">
                                    <div class="mws-form-col-2-8">
                                        <label class="mws-form-label">Bill Number</label>
                                        <div class="mws-form-item">
                                            <input type="text" name="bill_no" id="bill_no" required placeholder="Bill Number" value="<?php echo $sale->bill_no; ?>">
                                        </div>
                                    </div>
                                    <div class="mws-form-col-2-8">
                                        <label class="mws-form-label">Date</label>
                                        <div class="mws-form-item">
                                             <input type="text" name="date" class="datepicker" id="datepicker"  placeholder="<?php echo date("Y-m-d" , strtotime($sale->create_date)); ?>" value="<?php echo date("Y-m-d" , strtotime($sale->create_date)); ?>">
                                        </div>
                                    </div>
									 ...
									 <div class="mws-form-col-2-8">
                                        ...
                                        <div class="mws-form-item">
                                            <input type="text" name="credit_days" value="<?php echo $sale->credit_days; ?>" min=0 id="credit_days" required placeholder="Credit Days" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="mws-form-col-2-8">
                                        ...
                                        <select name="customer_id" id="customer_id" required>
                    						...
                    						<option value="<?php echo $customer->id; ?>" <?php if($sale->customer_id == $customer->id) { echo "selected"; } ?>><?php echo $customer->name; ?></option>
											<?php } ?>
                    					</select>
                                        </div>
                                    </div>
								...
								<div class="mws-form-cols">
									...
									<div class="mws-form-col-1-8">
										...
										<div class="mws-form-item">
											<input type="number" value="<?php echo $sale->paid; ?>" id="paid" name="paid" />
										</div>
									</div>
									...
									<div class="mws-form-col-1-8">
										...
										<select name="payment_method" id="payment_method"  onchange="">
											<option value="cash" <?php if($sale->paid_by == "cash") { echo "selected"; } ?>> Cash </option>
											<option value="cheque" <?php if($sale->paid_by == "cheque") { echo "selected"; } ?>> Cheque </option>
										</select>
										</div>
									</div>
									<?php if($sale->cheque_no) {  ?>
									<div class="mws-form-col-3-8" id="check_n">
                                        <label class="mws-form-label">Cheque #</label>
										<div class="mws-form-item">
											<input type="text" value="<?php echo $sale->cheque_no; ?>" id="cheque_no" name="cheque_no" />
										</div>
									</div>
									<?php } ?>
					 ...
					 <label class="mws-form-label">Invoice Items</label>
                        ...
                        <table class="mws-table">
                            ...
                            <tbody id="new_product">
								<?php $i =0; $p_ids = []; foreach($sale_items as $row)  {  ?>
									<tr>
									<td> <?php echo  $row->code; ?> </td>
									<td><?php echo $row->name; ?> 
									</td><td><input type='number' class='change_qty' data-id='<?php echo $row->product_id; ?>' value='<?php echo $row->sale_quantity; ?>' min=1 id='qty_<?php echo $row->product_id; ?>' name='qty_<?php echo  $row->product_id; ?>'> 
									...
									<td> <input type='text' width='5%' readonly value='<?php echo $row->unit_price * $row->sale_quantity; ?>' min=1 id='toatlprice_<?php echo  $row->product_id; ?>' ></td>
									</tr>
							...
							<thead id="sale_footer" >
								...
								<tr>
									...
									<th colspan=5> Tax </th>
									<th> <input type="text"  min=0 name="tax" value="<?php echo $sale->total_tax; ?>" id="tax" style="" /> </th>
								</tr>
								
								<tr>
									
									<th colspan=5> Discount </th>
									<th> <input type="text" value="<?php echo $sale->inv_discount; ?>"  min=0 name="discount" id="discount" style="" /> </th>
								</tr>
								...
								<tr>
									...
									<th> <input type="text" readonly value="<?php echo $sale->total; ?>" name="final_price" id="final_price" style="" /> </th>
								</tr>
							</thead>
						</table>
						...
						<br />
							...
							<div class="mws-form-cols">
                                    <div class="mws-form-col-8-8">
                                        ...
                                        <div class="mws-form-item">
                                            <textarea name="note" > <?php echo $sale->note; ?> </textarea>
                                        </div>
                                    </div>
